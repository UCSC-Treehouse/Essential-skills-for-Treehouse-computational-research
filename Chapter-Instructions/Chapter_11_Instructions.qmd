...
![City MPG vs Highway of Different car types](Images/Ch11_Exercises_pt1_Q2.png){width=55% fig-alt="Scatterplot showing positive correlation between city miles per gallon vs highway miles per gallon, across 3 types of vehicles" .border}
