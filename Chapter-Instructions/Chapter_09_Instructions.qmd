...
To change the geom in your plot, change the geom function that you add to ggplot(). For instance, the following code produces two plots that represent the same data (mpg):
