...
-   File --\> New Project --\> Quarto Project --\> New Directory 

![Create New Project](Images/create_new_project.png){.border fig-alt="Image showing how to open a new project from the file tab"}

![Create New Quarto Project](Images/new_quarto_project.png){fig-alt="Image showing new Quarto Project button" .border}

![Create New Quarto Project in New Directory](Images/project_in_new_directory.png){fig-alt="Image showing button on RStudio to 'Create New Project' within 'New Directory'" .border}
...
-   Create the project in your desktop, unless you want it to be a subdirectory of a Vaske Lab or Treehouse folder.
...
Now that you have created a project, you have a *workspace* for your computational work.
Next, let's start to create notebooks within this space to work in.
...
![Name New Quarto File](Images/name_new_quarto_file.png){.border
fig-alt="Image showing how to name and save a new quarto file in RStudio"}
...
This viewing mode is called 'Visual'.
Although helpful to preview what your output will look like, we want put the raw work somewhere else.
...
We can clear the automatically imported information by selecting all + delete.
Then, you will want to change your YAML heading to the following format:
...
Additionally, to avoid the automatic document info, click **'Create Empty Document'** rather than just 'Create'.
...
-   You will see your recent changes to files in *red*

-   Commit changes to main (i.e. not on a separate branch) with message "Initialize project with renv"
...
-   Create a new branch: 'chapter-01' (Branch --\> New Branch --\> Create Branch)

![Create a new branch on GitHub Desktop](Images/create_new_branch.png){.border
fig-alt="Image showing how to create a new branch on GitHub Desktop"}

2.  Push to GitHub:

-   Commit changes to 'chapter-01' branch

![Commit New Changes to New chapter-01 Branch](Images/push_new_changes_to_new_branch.png){.border fig-alt="Image showing how to push new files changes to new chapter 01 branch"}

**Note:** Your number of files to commit, as well as the changes on the file on the right (highlighted in red and green) will be different.
What you *should* see is 'Current Branch' chapter-01 (which you should have just created) on the top black bar and 'Commit _ file(s) to chapter-01' on the bottom left blue button.
...
![Assign your Mentor as Reviewer](Images/request_reviewer.png){.border fig-alt="Image showing GitHub browser where you will add a reviewer to your new pull request"}

Here, you should see 'base: main <-- compare: chapter-01'
