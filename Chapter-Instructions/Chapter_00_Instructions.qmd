...
Directory](Images/project_in_new_directory.png){#fig-repository
width=55% fig-alt="Image showing button on RStudio to "Create New
Project" within "New Directory"" fig-align="center" .border}

![Create New Quarto Project](Images/new_quarto_project.png){#fig-project
width=55% fig-alt="Image showing new Quarto Project button .border}

-   When creating your new Quarto project, you want to name it in the following format:
...
![Name New Project](Images/name_quarto_project.png){#fig-project .border
...
Next, you will want to change your YAML heading to the following format:
...
-   Create new branch: 'chapter-01' (Branch --\> New Branch --\> Publish Branch)
