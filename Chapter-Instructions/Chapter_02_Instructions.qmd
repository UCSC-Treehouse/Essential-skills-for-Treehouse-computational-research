...
Note that the value of x is not printed, it is just stored.
If you want to view the value, type x in the console.
(*hint: you can also highlight the object name by double clicking and pressing command + enter. another simple way, type the object name and run the line*)
...
Usually, this means you’ve forgotten either a " or a ).
...
4. Let’s revisit an exercise from Chapter 1.
...
**NEXT UP:** [Chapter 3](https://github.com/UCSC-Treehouse/Essential-skills-for-Treehouse-computational-research/blob/main/Chapter-Instructions/Chapter_03_Instructions.md)