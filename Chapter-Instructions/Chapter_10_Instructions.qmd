...
One way to do that is with fct_reorder(). For example, take the class variable in the mpg dataset.
...
2. Based on EDA, what variable in the diamonds dataset appears to be most important for predicting the price of a diamond? How is that variable correlated with cut?
...
**NEXT UP:** [Chapter 11](https://github.com/UCSC-Treehouse/Essential-skills-for-Treehouse-computational-research/blob/main/Chapter-Instructions/Chapter_11_Instructions.md)